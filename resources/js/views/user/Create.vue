    ...
    <md-card>
        ...
        <md-card-content class="row">
            <div class="col-lg-2 col-md-3">
                <fileUpload @upload="avatar = $event" :disabled="sending" :data="avatar"/>
            ...
            <div class="col-lg-10 col-md-9">
                <md-field md-clearable v-bind:class="{ 'md-invalid': errors.first('name') }">
                    ...
                    <md-input required :disabled="sending" v-model="user.name" data-vv-as="nombre" name="name"
                        v-validate="'required|min:5'" data-vv-name="name" maxlength="191" autofocus></md-input>
                ...
                <md-field v-bind:class="{ 'md-invalid': errors.first('password') }">
                    ...
                    data-vv-as="contraseña" v-validate="'required|min:5|max:10'"
        ...
        <md-card-actions>
            ...
            <md-button class="md-raised md-primary" :disabled="sending || errors.any()" @click="store()">Crear</md-button>
        </md-card-actions>
    </md-card>
    <md-snackbar md-position="center" :md-duration="2000" :md-active.sync="showSnackbar" md-persistent>
        <span>Exito. Se creo un nuevo usuario!</span>
    ...
    methods: {
            ...
            this.$validator.validateAll().then((result) => {
                if (this.avatar == null) {
                    this.$validator.errors.add({
                        field: 'avatar',
                        msg: 'El campo avatar es obligatorio'
                    });
                    return;
                }
                if (result) {
                    ...
                    this.$http.post('/api/users',fd).then(response => {
                        this.sending = false;
        ...
        avatar() {
            if(this.avatar == null) {
                ...
                this.$validator.errors.remove('avatar');
            }
        }
    }
}
